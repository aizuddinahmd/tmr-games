...
const Stats = () => {
  return (
    <Section className="bg-[#8F34FE] flex  items-center justify-center md:gap-0 gap-6">
      <div className="w-1/4 h-24 md:h-24 flex flex-col gap-1 md:gap-2 items-center md:p-0 p-1 justify-center  border-r-[2px]  border-slate-300">
        <Counter number={13400} />

        <p className="body-2 text-center">TOTAL GAMER</p>
      </div>
      <div className="w-1/4 h-24 md:h-24 flex flex-col gap-1 md:gap-2 items-center justify-center border-r-[2px]  border-slate-300">
